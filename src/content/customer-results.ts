...
export const customerResults: CustomerResult[] = [
  {
    ...
    images: ["/images/sections/ford-sid212-obd.webp"],
  ...
  },
  {
    ...
    vehicleYear: "B9",
    licensePlateVisible: false,
    images: ["/images/sections/datalog-road.webp"],
    serviceType: "ECU remap",
    stage: "Stage 1",
  ...
  },
  {
    ...
    vehicleYear: "MQB",
    licensePlateVisible: false,
    images: ["/images/sections/ecu-bench-red.png"],
    serviceType: "ECU remap",
    stage: "Stage 1",
  ...
  },
  {
    ...
    licensePlateVisible: false,
    images: ["/images/sections/obd-reprogramming.webp"],
    serviceType: "ECU remap",
    stage: "Stage 1",
    ecu: "Bosch ECU, afhankelijk van uitvoering",
    stockPowerHp: 194,
