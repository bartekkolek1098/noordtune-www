...
export const customerResults: CustomerResult[] = [
  ...
  }),
  {
    ...
    vehicleYear: "E83",
    transmission: "Afhankelijk van klantauto",
    ecu: "Bosch EDC17",
    serviceType: "ECU remap",
    stage: "Stage 1",
    fuelType: "Diesel",
    ...
    licensePlateVisible: false,
    images: [],
    imageAlt: "BMW X3 E83 2.0d Stage 1 concept klantresultaat",
    shortDescription:
      "Conceptcase op basis van door de eigenaar gedeelde waarden. Nog niet publiceren tot foto's, klantgoedkeuring en rechten zijn bevestigd.",
    technicalNotes: [
      "Motor: BMW N47",
      "ECU: Bosch EDC17",
      "Certificaat is volgens eigenaar aan de klant meegegeven",
      "Publicatie wacht op bevestigde foto's, klantakkoord en definitieve tekst"
    ],
    customerApproved: false,
    ...
    updatedAt: "2026-06-13",
    disclaimer:
      "Draft voor interne voorbereiding. Niet indexeren of publiceren voordat klantgoedkeuring, beeldrechten en definitieve voertuiggegevens zijn bevestigd.",
    relatedPowerCatalogUrl: site.catalogUrl,
    whatsappCta: site.whatsappUrl
  }
];
